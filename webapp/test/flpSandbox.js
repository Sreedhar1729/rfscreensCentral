					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData Application",
									"targetURL": "#comappodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappodata-display": {
								"semanticObject": "comappodata",
								"action": "display",
								"description": "OData Application",
								"title": "OData Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.odata",
									"url": sap.ui.require.toUrl("com/app/odata")
								}
							}
						}
					}
